...
Später wurde dann noch ein SRU-Server eingerichtet und die Schnittstelle OAI-Schnittstelle in Koha aktiviert. Leider konnte ich dem während der Vorlesung nicht folgen. Deswegen konnte ich wohl bei der späteren Export Übung die Daten aus Koha nicht exportieren. Ich habe den Server jetzt aber noch eingerichtet:
![SRUserver](https://raw.githubusercontent.com/slunz/Lerntagebuch-BAIN/master/pictures/SRUserver.png)

und dann einen OAI-Server eingerichtet
![OAIKoha](https://raw.githubusercontent.com/slunz/Lerntagebuch-BAIN/master/pictures/OAIKoha.png)


Während der Vorlesung hatte ich vergessen diese Schnittstelle zu aktivieren, was später dazu geführt hatte das ich die Daten aus Koha nicht exportieren konnte. Ich habe die Schnittstelle jetzt im Nachhinein noch aktiviert.
